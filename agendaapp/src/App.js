...
// valores default de agenda
const data = [ 
  {id: 1, nombre: "Fabio Fuentes Jefe", telefono: "+56945203736"},
  {id: 2, nombre: "RRHH", telefono: "+56920198682"},
  {id: 3, nombre: "Jesus Correa contabilidad", telefono: "+56945872165"},
];
// manipulacion de estados en la ejecucion
...
// retorno de el filtro de busqueda
  render() {  
    return (
      <>     
